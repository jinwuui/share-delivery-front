...
class SettingGatheringPlace extends StatefulWidget {
  const SettingGatheringPlace({Key? key}) : super(key: key);

  @override
  State<SettingGatheringPlace> createState() => _SettingGatheringPlaceState();
}

class _SettingGatheringPlaceState extends State<SettingGatheringPlace> {
